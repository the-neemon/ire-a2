...
\textbf{We also found a real leak in our own code, and fixing it raised accuracy.} Merging \eb{}'s
two history blocks described \textbf{99.8\% of validation and 99.9\% of training impressions with
history from their own future}; test was clean at 0.0\%. It was worth $+$0.0967 on the affected
