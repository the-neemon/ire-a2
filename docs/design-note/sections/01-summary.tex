...
\item \textbf{Honesty is nearly free.} Serving-unavailable features would add only \QnineDelta{}
  ...
  accuracy.
\item \textbf{Serving fits the budget, and exact search breaks at scale.} A single request takes
